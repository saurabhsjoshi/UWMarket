...
package com.collegecode.barcodescanner;
    ...
    public void onReceive(Context context, Intent intent){
      if (Intent.ACTION_BATTERY_CHANGED.equals(intent.getAction())) {
        ...
        if (intent.getIntExtra("plugged", -1) == 0) {
            com.collegecode.barcodescanner.InactivityTimer.this.onActivity();
        } else {
            com.collegecode.barcodescanner.InactivityTimer.this.cancel();
        }
      }
    }
  }
